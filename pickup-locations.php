...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="alert alert-danger" role="alert">
            <b>Note: You can verify unverified pickup locations of sellers from <a href="https://app.shiprocket.in/company-pickup-location?redirect_url=" target="_blank">shiprocket dashboard</a>. New number in pickup location has to be verified once, Later additions of pickup locations with a same number will not require verification.</b>
        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Need to verify the pickup locations</h5>
                                    ...
                                    <div class="modal-body">
                                        <ol>
                                            <li>After adding the pickup location from sellers/vendors you need to verify the pickup location on shiprocket dashboard.</li>
                                            <li> Note: You can verify unverified pickup locations of sellers from <a href="https://app.shiprocket.in/company-pickup-location?redirect_url=" target="_blank">shiprocket dashboard</a>. New number in pickup location has to be verified once, Later additions of pickup locations with a same number will not require verification.
                                            </li>
                                            <li>After verifying the pickup location in shiprocket, you need to verify that location in table.</li>
                                            <li>You will find <b> Verified </b> column in pickup location table in this page.</li>
                                        </ol>
                                    </div>
