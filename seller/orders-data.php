                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?= ((defined('ALLOW_MODIFICATION')) && (ALLOW_MODIFICATION == 0) || !($function->get_seller_permission($_SESSION['seller_id'], 'customer_privacy'))) ? $str_to_replace . substr($user_address[0]['mobile'], 7) : $user_address[0]['mobile']; ?></td>
                            </tr>
