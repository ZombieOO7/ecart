                        ...
                        <div id="variations">
                            ...
                            ?>
                                    <div class="row packate_div">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Weight (kgs)<i class="text-danger asterik">*</i></label><input type="text" name="weight[]" value='<?= $row['weight']; ?>' class="form-control min_value"></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>length(cms)</label><input type="text" name="length[]" value='<?= $row['length']; ?>' class="form-control min_value"></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Breadth(cms)</label><input type="text" name="breadth[]" value='<?= $row['breadth']; ?>' class="form-control min_value"></div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group"><label>Height(cms)</label><input type="text" name="height[]" value='<?= $row['height']; ?>' class="form-control min_value"></div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group"><label>HSN code</label><input type="text" name="hsn_code[]" value='<?= $row['hsn_code']; ?>' class="form-control min_value"></div>
                                        </div>
                            ...
                            if ($res[0]['type'] == "loose") {
                                foreach ($res as $row) { ?>
                                    <div class="row loose_div">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Weight (kgs)<i class="text-danger asterik">*</i></label><input type="text" name="weight_loose[]" value='<?= $row['weight']; ?>' class="form-control min_value"></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>length(cms)</label><input type="text" name="length_loose[]" value='<?= $row['length']; ?>' class="form-control min_value"></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group"><label>Breadth(cms)</label><input type="text" name="breadth_loose[]" value='<?= $row['breadth']; ?>' class="form-control min_value"></div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group"><label>Height(cms)</label><input type="text" name="height_loose[]" value='<?= $row['height']; ?>' class="form-control min_value"></div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group"><label>HSN code</label><input type="text" name="hsn_code_loose[]" value='<?= $row['hsn_code']; ?>' class="form-control min_value"></div>
                                        </div>
                                    </div>
                                <?php } ?>
