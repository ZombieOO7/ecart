                    ...
                    <div class="box-body">
                        ...
                        <div id="packate_div" style="display:none">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group"><label>HSN code</label><input type="text" name="hsn_code[]" class="form-control min_value"></div>
                                </div>
                        ...
                        <div id="loose_div" style="display:none;">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group"><label>HSN code</label><input type="text" name="hsn_code_loose[]" class="form-control min_value"></div>
                                </div>
