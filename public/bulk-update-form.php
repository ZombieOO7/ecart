...
<script>
    ...
    $('.box-footer > #sample').click(function(e) {
        ...
        // window.location.href = 'library/productsUpdate.csv';
        window.location.href = 'download.php?location=library/productsUpdate.csv&filename=productsUpdate.csv&extension=csv';
    ...
    $('.box-footer > #instructions').click(function(e) {
        ...
        e.preventDefault(); //stop the browser from following
        //whenever you click off an input element
        window.location.href = 'library/productsUpdate.txt';
        // window.location.href = 'download.php?location=library/productsUpdates.txt&filename=productsUpdate.txt&extension=txt';
