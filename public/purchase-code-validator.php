<?php 
if(isset($_GET) && isset($_GET['purchase_code']) && !empty($_GET['purchase_code']) || isset($_GET['purchase_code_app']) && !empty($_GET['purchase_code_app'])){
	$code = (isset($_GET['purchase_code']) || ($_GET['purchase_code_app']))  ? $_GET['purchase_code'] || $_GET['purchase_code_app'] : "";
	$error = false;
