                    ...
                    <form id="system_configurations_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="">Website <small>( Enable/Disable )</small></label><br>
                                    <input type="checkbox" id="website" class="js-switch" <?php if (!empty($modes['website']) && $modes['website'] == '1') {
                                                                                                echo 'checked';
                                                                                            } ?>>
                                    <input type="hidden" id="website_mode" name="website_mode" value="<?= (!empty($modes['website'])) ? $modes['website'] : 0; ?>">
                                </div>
                            </div>
                            <hr>
...
<script>
    ...
    var changeCheckbox = document.querySelector('#website');
    var init = new Switchery(changeCheckbox);
    changeCheckbox.onchange = function() {
        if ($(this).is(':checked')) {
            $('#website_mode').val(1);
