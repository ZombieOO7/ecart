                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <form method="post" id="shiprocket_settings_form">
                                    ...
                                    <hr>
                                    <div class="row">
                                        <p style="color:red;"><b>Note:</b> You can give free delivery charge only when <b>Standard delivery method</b> is enable.
                                        <p>
                                        <div class="form-group col-md-3">

                                            <label for="refer-earn-system">Enable Free Delivery Charge</label><br>
                                            <input type="checkbox" id="free_delivery_charge_button" class="js-switch" <?= (isset($shiprocket['free_delivery_charge']) && $shiprocket['free_delivery_charge'] == '1') ?  "checked" : ""; ?>>
                                            <input type="hidden" id="free_delivery_charge" name="free_delivery_charge" value="<?= (isset($shiprocket['free_delivery_charge'])) ? $shiprocket['free_delivery_charge'] : 0; ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="">Minimum free delivery order amount</label>
                                            <input type="text" class="form-control minimum_oredr_amount" name="minimum_oredr_amount" id="minimum_oredr_amount" value="<?= $shiprocket['minimum_oredr_amount'] ?>" placeholder='Minimum free delivery order amount' />
                                        </div>
                                    </div>
...
<script>
    ...
    var changeCheckbox = document.querySelector('#free_delivery_charge_button');
    var init = new Switchery(changeCheckbox);
    changeCheckbox.onchange = function() {
        if ($(this).is(':checked')) {
            $('#free_delivery_charge').val(1);
        } else {
            $('#free_delivery_charge').val(0);
        }
    };
    ...
    $(document).ready(function() {
        ...
        if ($('.ship_method_standard').is(':checked')) {
