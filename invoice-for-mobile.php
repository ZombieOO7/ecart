                        ...
                        <div class="col-sm-5 invoice-col">
                            ...
                            <address>
                                <?php if (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) {
                                    $mobile = str_repeat("*", strlen($res_outer[0]['mobile']) - 3) . substr($res_outer[0]['mobile'], -3);
                                } else {
                                    $mobile = $res_outer[0]['mobile'];
                                } ?>
                                <strong><?php echo $mobile ?></strong><br>
                            </address>
                            <address>
                                <?php if (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) {
                                    $email = str_repeat("*", strlen($res_outer[0]['email']) - 8) . substr($res_outer[0]['email'], -8);
                                } else {
                            ...
                            <div class="well">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <?php if (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) {
                                            $seller_email = str_repeat("*", strlen($seller_info[0]['email']) - 8) . substr($seller_info[0]['email'], -8);
                                        } else {
                                            $seller_email = $seller_info[0]['email'];
                                        } ?>
                                        <p>Email: <?= $seller_email ?></p>
                                        <?php if (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) {
                                            $seller_mobile = str_repeat("*", strlen($seller_info[0]['mobile']) - 3) . substr($seller_info[0]['mobile'], -3);
                                        } else {
                                            $seller_mobile = $seller_info[0]['mobile'];
                                        } ?>
                                        <p> Customer Care : +91 <?= $seller_mobile ?></p>
                                    </div>
                                    <div class="col-md-3">
                                        <strong>
