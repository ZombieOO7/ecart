...
class custom_functions
{
    ...
    public function process_shiprocket($order_id, $seller_id, $pickup_location, $sub_total, $weight, $height, $breadth, $length, $order_items_ids)
    {
        ...
        $data = array(
            ...
            'sub_total' => (isset($shiprocket_settings['free_delivery_charge']) && $shiprocket_settings['free_delivery_charge'] == "1" && $sub_total >= $shiprocket_settings['minimum_oredr_amount']) ? $sub_total : $sub_total + $get_currier_id['rate'],
            'length' => $length,
            'breadth' => $breadth,
            'height' => $height,
            'weight' => $weight
